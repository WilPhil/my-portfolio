  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-3 md:px-6 relative z-10">
        <div className="w-full md:max-w-4xl mx-auto flex justify-center items-center">
          <div className="w-[50%] md:w-[80%] flex flex-col md:pr-6 gap-4">
            ...
            <div className="flex flex-col items-end gap-4">
              <span className="text-5xl md:text-7xl font-bold tracking-tighter text-white text-right">
                Wilsent Philip Lo
              </span>
